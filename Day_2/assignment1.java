...
public class assignment1 {
    public static void main(String[] args) {
        ...
        int total_balance = 5000;  // Starting balance
        int n;

        while (true) {
            System.out.println("Please enter the number by refering the operations below:");
            ...
            switch (n) {
                case 1:
                    ...
                    total_balance = total_balance + depositAmount;
